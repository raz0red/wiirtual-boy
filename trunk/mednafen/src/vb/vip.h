...
namespace MDFN_IEN_VB
{
  ...
  uint8 MDFN_FASTCALL VIP_Read8(v810_timestamp_t &timestamp, uint32 A);
  uint16 MDFN_FASTCALL VIP_Read16(v810_timestamp_t &timestamp, uint32 A);


  void MDFN_FASTCALL VIP_Write8(v810_timestamp_t &timestamp, uint32 A, uint8 V);
  void MDFN_FASTCALL VIP_Write16(v810_timestamp_t &timestamp, uint32 A, uint16 V);
